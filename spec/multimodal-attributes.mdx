---
title: "Multimodal Attributes"
description: "Image, audio, and mixed-content messages"
---
...
config = TraceConfig(
    hide_input_images=True,  # Redact image URLs
    base64_image_max_length=10000,  # Limit base64 images to 10KB
    hide_input_text=False  # Keep text content
)
```

```typescript TypeScript
const traceConfig = {
  hideInputImages: true,  // Redact image URLs
  base64ImageMaxLength: 10000,  // Limit base64 images to 10KB
  hideInputText: false  // Keep text content
}
```
