---
title: "LLM Spans"
description: "Attributes for language model calls: messages, token counts, model parameters, and tool definitions"
---
...
<Info>
See [Configuration](/spec/configuration-spec) for details on how to set these context attributes.
</Info>
...
<Info>
See [Tool Calling](/spec/tool-calling) for the complete tool calling flow.
</Info>
