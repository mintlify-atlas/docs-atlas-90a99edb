...
<CardGroup cols={2}>
  <Card title="Python instrumentations" icon="python" href="/python">
    Explore all 30+ Python instrumentation libraries
  </Card>
  <Card title="JavaScript instrumentations" icon="js" href="/javascript">
    Explore JavaScript/TypeScript instrumentations
  </Card>
  <Card title="Privacy controls" icon="shield-halved" href="/tracing/privacy">
    Configure data masking and PII protection
  </Card>
  <Card title="Production deployment" icon="rocket" href="/deployment">
    Deploy OpenInference in production with OTLP collectors
  </Card>
</CardGroup>
